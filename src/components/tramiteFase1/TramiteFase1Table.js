...
function createDataTramiteFase1(tramiteFase1) {
  return {
    id: tramiteFase1.id,
    alumno: tramiteFase1.alumno,
    tipo_tramite : tramiteFase1.tipo_tramite,
    fecha_solicitud: tramiteFase1.fecha_solicitud,
    ciclo_escolar: tramiteFase1.ciclo_escolar,
    atributos_dictamen: tramiteFase1.atributos_dictamen
...
const EnhancedTableToolbar = (props) => {
  ...
  const { numSelected, setConfigCreateTramiteFase1, setOpenCreateModal } = props;

  const handleClickCreate = () => {
    setConfigCreateTramiteFase1({
      type: 'CREATE',
      item: null
    })
  ...
  return (
    ...
    >
      ...
      <Tooltip title="Agregar TramiteFase1" aria-label="add">
...
export default function TramiteFase1Table({
  setOpenCreateModal,
  setOpenDelete,
  ...
  const getTramiteFase1s = async () => {
    console.log('Getting data...')
    const tramiteFase1 = await as.getTramiteFase1s()
    setRows(tramiteFase1.map(a => createDataTramiteFase1(a)));
    setLoading(false);
  }
  ...
  const handleClickDelete = (id) => {
    setDeleteTramiteFase1({ id, del: false })
    setOpenDelete(true);
  }
