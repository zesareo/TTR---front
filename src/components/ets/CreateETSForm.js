...
const CreateUserForm = ({
  ...
  let { id, alumno, turno, precio, materia, fecha, estatus } = userData;
      ...
      {loading
        ...
        <div>
          ...
          <form className={classes.root} noValidate autoComplete="off">
            ...
            <TextField id="estatus" name="estatus" onChange={handleOnChange} value={estatus} label="Domicilio" variant="outlined" />
          </form>
        </div>
