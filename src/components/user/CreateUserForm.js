...
const CreateUserForm = ({
  ...
  let { id, nombre, materno, paterno, nacimiento, telefono, domicilio, correo, rol, contrasena, confirmcontrasena } = userData;
    ...
    <Fragment>
      {loading
        ...
        <div style={{ width: 550, height: 270, textAlign: "center" }}>
          <Spinner></Spinner>
          <p style={{ padding: 10, margin: 10 }}> {type === 'CREATE' ? 'Creando' : 'Actualizando'}  Usuario...</p>
        </div>
